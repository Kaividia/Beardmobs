package com.kaividian.beardmobs.entity.projectile;
...
public class ProjectileSpit extends Entity implements IProjectile
{
    ...
    public ProjectileSpit(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public ProjectileSpit(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public ProjectileSpit(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public ProjectileSpit(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        {
        	EntitySpit spit = new EntitySpit(this.worldObj, 0f, 0, 0);
            spit.setPositionAndRotation(this.posX, this.posY, this.posZ, 0, 0);
        ...
        else
        {
            ...
            for (i = 0; i < list.size(); ++i)
            {
                ...
                if (entity1.canBeCollidedWith() && (entity1 != this.shootingEntity || this.ticksInAir >= 5) && !(entity1 instanceof EntitySpit) && !(entity1 instanceof EntityVesper))
                {
                    f1 = 0.3F;
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                   ...
                   // else
                    ...
                    movingobjectposition.entityHit.attackEntityFrom(damagesource, 2f);
                    EntitySpit spit = new EntitySpit(this.worldObj, 0.0f, 0, 0);
                    spit.setPositionAndRotation(movingobjectposition.entityHit.posX, movingobjectposition.entityHit.posY, movingobjectposition.entityHit.posZ, 0, 0);
                    this.worldObj.spawnEntityInWorld(spit);
                    this.kill();
                    }
